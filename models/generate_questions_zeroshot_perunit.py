...
log_info("Strategy: ZERO-SHOT RAG LLM (with concept context, NO example questions)")
...
for unit_idx, unit in enumerate(kb['unit'], 1):
    ...
    for bloom_level in bloom_levels:
        ...
        for i in range(count):
            ...
            # Pick a random concept from this unit (ZERO-SHOT: only concept, no examples)
...
output_file = f'data/generated_question/generated_questions_zeroshot_perunit_{timestamp}.json'
